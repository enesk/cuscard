...
<head>
    ...
    <link href="{{ asset('css/flip_switch.css')}}" rel="stylesheet">
    <link href="{{ asset('dist/assets/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{ asset('dist/assets/css/simple-line-icons.css')}}" rel="stylesheet">
<!--<link href="{{ asset('dist/styles.bundle.js')}}" rel="stylesheet">-->
    <!-- Scripts -->
    <script>
...
<body>
    ...
    <script type="text/javascript" src="{{ asset('dist/scripts.bundle.js')}}"></script>
